...
#include "objects/object_gi_melody/object_gi_melody.h" // added unused gi_melody
...
void DemoKankyo_DrawNotes(Actor* thisx, GlobalContext* globalCtx); // added unused gi_melody
...
static s16 sObjIds[] = {
    ...
    OBJECT_GAMEPLAY_KEEP,  OBJECT_GAMEPLAY_KEEP,  OBJECT_GAMEPLAY_KEEP,  OBJECT_GI_MELODY,
};
...
void DemoKankyo_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->actor.objBankIndex == this->objBankIndex) {
        switch (this->actor.params) {
            ...
            case DEMOKANKYO_C:
            case DEMOKANKYO_D:
                DemoKankyo_DrawNotes(thisx, globalCtx);
                break;
        }
    }
...
void DemoKankyo_DrawNotes(Actor* thisx, GlobalContext* globalCtx) {
    DemoKankyo* this = (DemoKankyo*)thisx;
    switch (this->actor.params) {
        case DEMOKANKYO_8:
